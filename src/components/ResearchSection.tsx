  ...
  return (
    <div className="py-4 flex flex-col items-center">
      <svg width="180" height="80" viewBox="0 0 180 80" className="overflow-visible">
        ...
        {/* Label */}
        <text x="35" y="45" fill="#fcd34d" fontSize="14" fontWeight="500" textAnchor="end" clipPath="url(#tripleClip)">
          Inputs
        </text>
  ...
  return (
    <div className="py-4 flex justify-center">
      <svg width="200" height="80" viewBox="0 0 200 80" className="overflow-visible max-w-full">
        ...
        <path
          d="M45 0 C45 5, 45 8, 45 10 C20 15, 20 25, 45 30 C70 35, 70 45, 45 50 C20 55, 20 65, 45 70 C45 72, 45 75, 45 80"
          stroke="url(#movingGradient2a1)"
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M50 0 C50 5, 50 8, 50 10 C25 15, 25 25, 50 30 C75 35, 75 45, 50 50 C25 55, 25 65, 50 70 C50 72, 50 75, 50 80"
          stroke="url(#movingGradient2a2)"
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M55 0 C55 5, 55 8, 55 10 C30 15, 30 25, 55 30 C80 35, 80 45, 55 50 C30 55, 30 65, 55 70 C55 72, 55 75, 55 80"
          stroke="url(#movingGradient2a3)"
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
        />
        ...
        <g style={{ transform: "scaleX(-1)", transformOrigin: "100px 40px" }}>
          <path
            d="M53 0 C53 5, 53 8, 53 10 C28 15, 28 25, 53 30 C78 35, 78 45, 53 50 C28 55, 28 65, 53 70 C53 72, 53 75, 53 80"
            stroke="url(#movingGradient2b1)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M57 0 C57 5, 57 8, 57 10 C32 15, 32 25, 57 30 C82 35, 82 45, 57 50 C32 55, 32 65, 57 70 C57 72, 57 75, 57 80"
            stroke="url(#movingGradient2b2)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M61 0 C61 5, 61 8, 61 10 C36 15, 36 25, 61 30 C86 35, 86 45, 61 50 C36 55, 36 65, 61 70 C61 72, 61 75, 61 80"
            stroke="url(#movingGradient2b3)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M65 0 C65 5, 65 8, 65 10 C40 15, 40 25, 65 30 C90 35, 90 45, 65 50 C40 55, 40 65, 65 70 C65 72, 65 75, 65 80"
            stroke="url(#movingGradient2b4)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M69 0 C69 5, 69 8, 69 10 C44 15, 44 25, 69 30 C94 35, 94 45, 69 50 C44 55, 44 65, 69 70 C69 72, 69 75, 69 80"
            stroke="url(#movingGradient2b5)"
            strokeWidth="3"
            fill="none"
            strokeLinecap="round"
          />
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="grid grid-cols-3 gap-x-3 gap-y-1 px-1">
          {Array.from({ length: 9 }).map((_, i) => (
            <span
              key={i}
              className="text-primary text-center text-base leading-4 w-4 h-4 flex items-center justify-center"
            >
              •
            </span>
          ))}
    ...
    <section id="research" className="py-28 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          <p className="text-primary font-display font-medium mb-4 tracking-widest uppercase text-xs">Research Focus</p>
        ...
        {/* Research block */}
        <div className="mb-20">
          <div className="group w-fit mx-auto p-8 md:p-10 rounded-lg bg-card/25 border border-border/35 hover:border-primary/30 transition-all duration-300">
            {" "}
